...
var cnItems = {
    ...
    "replicanti, make their growth is rooted by": "复制品，让他们的成长根植于",
    ...
    "Reset your Replicanti, but makes Replicanti upgrades is": "重置您的 复制品，但使 复制品 升级是",
...
var cnRegReplace = new Map([
    ...
    [/^Make Replicanti growth is (.+) stronger.$/, '使 复制品 增长 $1 那么多。'],
	[/^([\d\.]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+) OOMs\/sec$/, '$1 OOMs\/秒'],
	[/^([\d\.]+) OOMs\/sec$/, '$1 OOMs\/秒'],
